...
class __TwigTemplate_9b510db987060f038a01d03e199c222cf60cf0631cdae0fd73057f3324282e3e extends \Twig\Template
{
    public function __construct(Environment $env)
    {
        ...
        $tags = ["if" => 40, "set" => 54, "include" => 75];
        $filters = ["escape" => 27, "raw" => 29, "safe_join" => 30, "clean_class" => 56, "t" => 66];
        $functions = [];
...
<html";
  ...
  <head> 
    ...
    ";
        ...
        // line 49
        echo "
    <script id=\"mcjs\">!function(c,h,i,m,p){m=c.createElement(h),p=c.getElementsByTagName(h)[0],m.async=1,m.src=i,p.parentNode.insertBefore(m,p)}(document,\"script\",\"https://chimpstatic.com/mcjs-connected/js/users/14df423e6cb4842317f540f1c/7e1af9c5035224c0640c9902c.js\");</script>
        
  </head>

  ";
        // line 54
        $context["body_classes"] = [0 => ((        // line 55
($context["logged_in"] ?? null)) ? ("logged-in") : ("")), 1 => (( !        // line 56
($context["root_path"] ?? null)) ? ("frontpage") : (("path-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["root_path"] ?? null)))))), 2 => ((        // line 57
($context["node_type"] ?? null)) ? (("node--type-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["node_type"] ?? null))))) : ("")), 3 => ((        // line 58
($context["node_id"] ?? null)) ? (("node-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["node_id"] ?? null))))) : (""))];
  ...
  <body";
        ...
        echo " style=\"background-image: url('/themes/custom/gavias_edmix/images/patterns/fondo2.jpg');
background-repeat: repeat;\" >
    ...
    ";
        ...
        ";
            // line 75
            $this->loadTemplate(($context["addon_template"] ?? null), "themes/custom/gavias_edmix/templates/page/html.html.twig", 75)->display($context);
            // line 76
            echo "      </div>  
    ";
        }
...
";
    ...
    {
        return array (  175 => 78,  171 => 76,  169 => 75,  164 => 74,  162 => 73,  157 => 71,  153 => 70,  149 => 69,  145 => 68,  140 => 66,  133 => 62,  130 => 61,  128 => 58,  127 => 57,  126 => 56,  125 => 55,  124 => 54,  117 => 49,  111 => 47,  109 => 46,  106 => 45,  100 => 42,  97 => 41,  95 => 40,  90 => 38,  85 => 36,  81 => 35,  76 => 33,  71 => 31,  67 => 30,  63 => 29,  58 => 27,  55 => 26,);
    }
    ...
    {
        return new Source("", "themes/custom/gavias_edmix/templates/page/html.html.twig", "/Users/rafaelgato/sitios/kdrupal_des/web/themes/custom/gavias_edmix/templates/page/html.html.twig");
    }
}

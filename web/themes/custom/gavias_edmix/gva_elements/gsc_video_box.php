         ...
         <div class="video-inner">
            ...
            <div class="video-body">
               <a class="popup-video gsc-video-link" href="<?php print $content ?>">
                  <svg class="svg-inline--fa fa-w-16 icon-play space-40" aria-hidden="true" data-fa-processed data-prefix="fa" data-icon="null"
                  role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"></svg>
